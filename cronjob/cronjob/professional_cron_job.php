<?php
 //require_once 'C:\Users\User\vendor\autoload.php'; 
	...
	//use \var\www\html\application\libraries\Twilio\twilio\sdk\Twilio\TwiML\Voice\Client;
 ...
 //    echo $row->duration;
	...
	// $sql  =   "SELECT distinct(mobile) as mobile, CONCAT(firstname,' ',lastname) as cust_name FROM users
